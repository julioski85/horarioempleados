...
$routes = [
    'GET' => [
        ...
        '/admin/attendance-records' => fn () => (new AdminController())->attendanceRecords(),
    ...
    'POST' => [
        ...
        '/admin/attendance-records/void' => fn () => (new AdminController())->voidAttendanceRecord(),
        '/admin/attendance-records/restore' => fn () => (new AdminController())->restoreAttendanceRecord(),
